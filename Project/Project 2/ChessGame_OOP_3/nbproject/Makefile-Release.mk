...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/chessgame_oop_3.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/chessgame_oop_3.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/chessgame_oop_3 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/updateGameState.o: updateGameState.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/updateGameState.o updateGameState.cpp
