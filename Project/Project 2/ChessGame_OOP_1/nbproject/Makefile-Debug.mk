...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/chessgame_oop_1.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/chessgame_oop_1.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/chessgame_oop_1 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/displayBoard.o: displayBoard.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/displayBoard.o displayBoard.cpp

${OBJECTDIR}/getPlayerInfo.o: getPlayerInfo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/getPlayerInfo.o getPlayerInfo.cpp

${OBJECTDIR}/getPlayerMoveStart.o: getPlayerMoveStart.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/getPlayerMoveStart.o getPlayerMoveStart.cpp

${OBJECTDIR}/initializeBoardPieces.o: initializeBoardPieces.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/initializeBoardPieces.o initializeBoardPieces.cpp

${OBJECTDIR}/isCheck.o: isCheck.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/isCheck.o isCheck.cpp

${OBJECTDIR}/isWhite.o: isWhite.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/isWhite.o isWhite.cpp
...
${OBJECTDIR}/pieceSearchArrayPosition.o: pieceSearchArrayPosition.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pieceSearchArrayPosition.o pieceSearchArrayPosition.cpp

${OBJECTDIR}/tiles.o: tiles.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tiles.o tiles.cpp

${OBJECTDIR}/updateTiles.o: updateTiles.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/updateTiles.o updateTiles.cpp

${OBJECTDIR}/verifyPlayerMoveStart.o: verifyPlayerMoveStart.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/verifyPlayerMoveStart.o verifyPlayerMoveStart.cpp
