...
${OBJECTDIR}/VPMCheckAlpha.o: VPMCheckAlpha.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VPMCheckAlpha.o VPMCheckAlpha.cpp

${OBJECTDIR}/VPMCheckCapture.o: VPMCheckCapture.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VPMCheckCapture.o VPMCheckCapture.cpp

${OBJECTDIR}/VPMCheckColor.o: VPMCheckColor.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VPMCheckColor.o VPMCheckColor.cpp

${OBJECTDIR}/VPMCheckMovement.o: VPMCheckMovement.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VPMCheckMovement.o VPMCheckMovement.cpp

${OBJECTDIR}/VPMCheckNum.o: VPMCheckNum.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VPMCheckNum.o VPMCheckNum.cpp

${OBJECTDIR}/VPMCheckPiece.o: VPMCheckPiece.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VPMCheckPiece.o VPMCheckPiece.cpp

${OBJECTDIR}/VPMKingMoveSafe.o: VPMKingMoveSafe.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VPMKingMoveSafe.o VPMKingMoveSafe.cpp

${OBJECTDIR}/VPMisBlocked.o: VPMisBlocked.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VPMisBlocked.o VPMisBlocked.cpp

${OBJECTDIR}/VPMkingNotinCheck.o: VPMkingNotinCheck.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VPMkingNotinCheck.o VPMkingNotinCheck.cpp

${OBJECTDIR}/cannotMove.o: cannotMove.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cannotMove.o cannotMove.cpp

${OBJECTDIR}/convertAtlasCoordinatesToNumeric.o: convertAtlasCoordinatesToNumeric.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/convertAtlasCoordinatesToNumeric.o convertAtlasCoordinatesToNumeric.cpp

${OBJECTDIR}/convertNumericToAtlasCoordinates.o: convertNumericToAtlasCoordinates.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/convertNumericToAtlasCoordinates.o convertNumericToAtlasCoordinates.cpp

${OBJECTDIR}/copyTiles.o: copyTiles.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/copyTiles.o copyTiles.cpp

${OBJECTDIR}/createMoveList.o: createMoveList.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/createMoveList.o createMoveList.cpp

${OBJECTDIR}/displayBoard.o: displayBoard.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/displayBoard.o displayBoard.cpp

${OBJECTDIR}/findSupports.o: findSupports.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/findSupports.o findSupports.cpp

${OBJECTDIR}/gameEnd.o: gameEnd.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gameEnd.o gameEnd.cpp

${OBJECTDIR}/generatePossibleMoves.o: generatePossibleMoves.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/generatePossibleMoves.o generatePossibleMoves.cpp

${OBJECTDIR}/getPlayerMoveEnd.o: getPlayerMoveEnd.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/getPlayerMoveEnd.o getPlayerMoveEnd.cpp

${OBJECTDIR}/getPlayerMoveStart.o: getPlayerMoveStart.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/getPlayerMoveStart.o getPlayerMoveStart.cpp

${OBJECTDIR}/initializeBoardPieces.o: initializeBoardPieces.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/initializeBoardPieces.o initializeBoardPieces.cpp

${OBJECTDIR}/is50Moves.o: is50Moves.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/is50Moves.o is50Moves.cpp

${OBJECTDIR}/isCheck.o: isCheck.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/isCheck.o isCheck.cpp

${OBJECTDIR}/isCheckmate.o: isCheckmate.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/isCheckmate.o isCheckmate.cpp

${OBJECTDIR}/isInsufficient.o: isInsufficient.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/isInsufficient.o isInsufficient.cpp

${OBJECTDIR}/isStalemate.o: isStalemate.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/isStalemate.o isStalemate.cpp

${OBJECTDIR}/isWhite.o: isWhite.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/isWhite.o isWhite.cpp

${OBJECTDIR}/movePossible.o: movePossible.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/movePossible.o movePossible.cpp

${OBJECTDIR}/outputData.o: outputData.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/outputData.o outputData.cpp

${OBJECTDIR}/outputInstructions.o: outputInstructions.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/outputInstructions.o outputInstructions.cpp

${OBJECTDIR}/outputName.o: outputName.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/outputName.o outputName.cpp

${OBJECTDIR}/pawnPromotion.o: pawnPromotion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pawnPromotion.o pawnPromotion.cpp

${OBJECTDIR}/pawnUpdate.o: pawnUpdate.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pawnUpdate.o pawnUpdate.cpp

${OBJECTDIR}/pieceSearchArrayPosition.o: pieceSearchArrayPosition.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pieceSearchArrayPosition.o pieceSearchArrayPosition.cpp

${OBJECTDIR}/printMoveList.o: printMoveList.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/printMoveList.o printMoveList.cpp

${OBJECTDIR}/readInPieceDataNames.o: readInPieceDataNames.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/readInPieceDataNames.o readInPieceDataNames.cpp

${OBJECTDIR}/updateMoveList.o: updateMoveList.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/updateMoveList.o updateMoveList.cpp

${OBJECTDIR}/updateTiles.o: updateTiles.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/updateTiles.o updateTiles.cpp

${OBJECTDIR}/verifyPlayerMove.o: verifyPlayerMove.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/verifyPlayerMove.o verifyPlayerMove.cpp

${OBJECTDIR}/verifyPlayerMoveEnd.o: verifyPlayerMoveEnd.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/verifyPlayerMoveEnd.o verifyPlayerMoveEnd.cpp

${OBJECTDIR}/verifyPlayerMoveStart.o: verifyPlayerMoveStart.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/verifyPlayerMoveStart.o verifyPlayerMoveStart.cpp
